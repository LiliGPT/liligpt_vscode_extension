...
export class FileUtils {
   ...
   * @returns absolute path to file or directory
   */
  public static abspath(path: string, errorString?: string): string {
   ...
   */
  public static exists(paths: string[], errorString?: string): boolean {
   ...
   */
  public static readAsString(path: string, errorString?: string): string {
    const filepath = FileUtils.abspath(path, errorString);
